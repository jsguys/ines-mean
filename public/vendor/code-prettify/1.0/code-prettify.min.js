...
e=r};e.type="text/javascript";e.src="/vendor/code-prettify/lang-"+encodeURIComponent(D[m])+".js";L.insertBefore(e,L.firstChild)})(D[m]);for(var R=D.length,A=[],m=0,z=N.length;m<z;++m)A.push("/vendor/code-prettify/"+encodeURIComponent(N[m])+".css");A.push("/vendor/code-prettify/prettify.css");(function(e){function j(m){if(m!==w){var n=x.createElement("link");n.rel="stylesheet";n.type="text/css";
